...
def get_hs_img(hs, add_images_path=True):
...
def get_hs_imgs(gloss):
    ...
    return {
        "dom_start": url_for(get_hs_img(hs_dict["dom_start"])),
        "dom_end": url_for('static', filename=get_hs_img(hs_dict["dom_end"])),
        "non_dom_start": url_for(get_hs_img(hs_dict["non_dom_start"])),
        "non_dom_end": url_for(get_hs_img(hs_dict["non_dom_end"]))
    }